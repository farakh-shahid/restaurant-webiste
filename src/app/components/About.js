...
const About = () => {
  return (
    <section 
      ...
      style={{
        backgroundImage: 'url(/bg-food-dark.png)',
    ...
    >
      ...
      <div className="relative z-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="font-display text-4xl md:text-5xl font-bold text-gray-100 mb-4">
              About Us
            </h2>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8">
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-100 mb-2">Made with Love</h3>
                  <p className="text-sm text-gray-200">Every dish prepared with passion and care</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-100 mb-2">Family Friendly</h3>
                  <p className="text-sm text-gray-200">Welcoming atmosphere for all ages</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-100 mb-2">Authentic Taste</h3>
                  <p className="text-sm text-gray-200">Traditional Pakistani flavors</p>
                </div>
              </div>
            </motion.div>
