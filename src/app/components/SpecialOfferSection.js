...
const SpecialOfferSection = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: "url('/bg-offer.jpg')",
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-start max-w-2xl px-8 py-12">
        ...
        <h2 className="text-4xl md:text-5xl font-extrabold mb-2 leading-tight">PEPPERED PORK RIBS</h2>
        <h3 className="text-3xl md:text-4xl font-bold mb-6">30% OFF FRIDAY ONLY</h3>
        <a
          href="#book"
